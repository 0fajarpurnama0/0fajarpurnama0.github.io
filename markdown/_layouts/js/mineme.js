...
function mining() {
  ...
  if ($('[type=range]').val() > 0) {
    _client.start();
    $('#message').html('Intitially this site cost 10% of your CPU however I respect knowledge, if you know how to block mining is fine, if not you can stop anytime here. Thank you for donating at most ' + (100 - (_client.getThrottle() * 100)) + '% of your processing power for mining Mineme! Reference: <a href="https://www.coinimp.com/invite/8c923bdd-07f9-4051-a110-bf3db7fb8d07">https://www.coinimp.com/invite/8c923bdd-07f9-4051-a110-bf3db7fb8d07</a>.');
  } else {
    _client.stop();
