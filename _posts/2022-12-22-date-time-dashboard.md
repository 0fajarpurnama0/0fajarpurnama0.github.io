---
layout: post
title: Date Time Dashboard in HTML CSS JavaScript
description: Date Time Dashboard in hyper text markup language, cascading style sheets, and javascript.
featuredimage: 
category: tools
tags: [tools, Date Time Dashboard, html css, js]
canonicalurl: https://0fajarpurnama0.github.io/tools/2022/12/22/date-time-dashboard
---
<style>
   /* style.css */
   .container {
