...
*   [![https://file.army/i/BYcB1FH](https://404store.com/2020/04/13/nc.gif)**NonCommercial (nc)**](https://creativecommons.org/use-remix/cc-licenses) prohibits of selling, taking profit, and everything else related to commercial.
*   [![https://file.army/i/BYcBMNf](https://404store.com/2020/04/13/nd.gif)**NoDerivatives (nd)**](https://creativecommons.org/use-remix/cc-licenses) prohibits any modification such adding characters, adding strokes to images, creating other formats such as html and pdf, and etc. The content must absolutely remain as it is.
