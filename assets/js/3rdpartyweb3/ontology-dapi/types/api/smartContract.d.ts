...
export interface SmartContractApi {
     ...
     * @throws NO_ACCOUNT
     */
    deploy({ code, name, version, author, email, description, vmType, gasPrice, gasLimit }: {
        code: string;
        name?: string;
        version?: string;
        author?: string;
     ...
     * @throws NO_ACCOUNT, MALFORMED_CONTRACT
     */
    invokeWasm({ scriptHash, operation, args, gasPrice, gasLimit, requireIdentity }: {
        scriptHash: string;
        operation: string;
        args?: Parameter[];
        gasPrice?: number;
     ...
     * @throws MALFORMED_CONTRACT
     */
    invokeWasmRead({ scriptHash, operation, args }: {
        scriptHash: string;
        operation: string;
        args?: Parameter[];
    }): Promise<any>;
