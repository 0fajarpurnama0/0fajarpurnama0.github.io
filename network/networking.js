$("#generalinformation").click(function(){
    $(".grid-content").html(`

<p></p><p style="margin-bottom: 0in; line-height: 150%" align="justify"><b>Course Overview and Introduction</b></p>
<p style="margin-bottom: 0in; line-height: 150%" align="justify">This topic would like to show you from afar what a computer network looks like. We won't show you deep inside because that's where things tends to get difficult, for example subnets, network traffic, protocols, etc. Simply we want to Introduce what is the computer network, how today's people rely on it now, and how is it even or how we are able to use it. From afar The Internet looks complicated as on Figure 1, but to explain it simply it's a connection of so many nodes consist of computer, servers, and other networking devices.<br></p><p style="margin-bottom: 0in; line-height: 150%; text-align: center;"><img src="https://md.hicc.cs.kumamoto-u.ac.jp/draftfile.php/50/user/draft/683060162/internet-map.gif" alt="Millions of nodes connected" style="" class="img-responsive atto_image_button_text-bottom" height="304" width="427"><br></p><p style="margin-bottom: 0in; line-height: 150%; text-align: center;">Figure 1. Internet Illustrated <br></p><p style="margin-bottom: 0in; line-height: 150%; text-align: center;">(https://www.andrew.cmu.edu/user/pcarboni/internet_history_site/)<br></p>
<p style="margin-bottom: 0in; line-height: 150%" align="justify"><br>

</p>
<p style="margin-bottom: 0in; line-height: 150%" align="justify"><b>Learning Objective</b></p>If some stranger asked you of what is The Internet and you can answer simply, then you got the gist of this course. If you can find the puzzle pieces and form the picture of The Internet puzzle, then you have fulfilled the learning objective of this course. For now we would like to list the following learning objective.<br><ol><li>Simulate Local Area Network (LAN).</li><li>Simulate Wide Area Network (WAN).</li><li>Common services of The Internet.</li><li>Design your simple cloud (Figure 2 for example).<br></li></ol><div style="text-align: center;"><img src="https://md.hicc.cs.kumamoto-u.ac.jp/draftfile.php/50/user/draft/683060162/Sample-Cloud-Simulation.png" alt="Miniature Internet (My Version)" style="" class="img-responsive atto_image_button_text-bottom" height="740" width="1017"><br></div>
<p style="margin-bottom: 0in; line-height: 150%; text-align: center;">Figure 2. Sample Network Simulation<br>

</p>
<p style="margin-bottom: 0in; line-height: 150%" align="justify"><b>Assessment and Measurement</b></p>
<p style="margin-bottom: 0in; line-height: 150%" align="justify">It's up to you of how to do this course but it is recommended to do the following:</p>
<ol><li>Read the contents. <br></li><li>Do the quizzes to enrich your understanding of the content. <br></li><li>Submit assignments, more of making a simulation.<br></li><li>We never meant to place difficult materials so aim for perfect scores before proceeding to the next material since attempting a grade is unlimited.</li></ol>
<p style="margin-bottom: 0in; line-height: 150%" align="justify">Once again the top instructions are just our recommendation, do the course as you wish.</p>
<ul><li>If your overall score is below 50% you should complete more materials or aim for higher grade. <br></li><li>If it's above you are ready to dive into computer programming world. <br></li><li>If you got 100% then you should have no problem in adapting or learning new programming languages.</li></ul><p></p>
