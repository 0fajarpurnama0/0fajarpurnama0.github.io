...
export interface GovernanceApi {
     ...
     */
    stakePeers({ peerPubKeys, amounts, gasPrice, gasLimit }: {
        peerPubKeys: string[];
        amounts: string[];
        gasPrice?: string;
        gasLimit?: string;
     ...
     * @return Transaction hash
     */
    redeemPeers({ peerPubKeys, amounts, gasPrice, gasLimit }: {
        peerPubKeys: string[];
        amounts: string[];
        gasPrice?: string;
        gasLimit?: string;
     ...
     * @return Transaction hash
     */
    withdrawFeeReward({ gasPrice, gasLimit }: {
        gasPrice?: string;
        gasLimit?: string;
    }): Promise<string>;
    /**
     ...
     * @param gasLimit Suggested limit of gas
     */
    withdrawUnfrozenOnt({ peerPubKeys, amounts, gasPrice, gasLimit }: {
        peerPubKeys: string[];
        amounts: string[];
        gasPrice?: string;
        gasLimit?: string;
     ...
     * @return Transaction hash
     */
    withdrawPeerUnboundOng({ gasPrice, gasLimit }: {
        gasPrice?: string;
        gasLimit?: string;
    }): Promise<string>;
    /**
